...
if language == "Georgian":
    ...
    st.markdown("""<p style="color:#3A485F;">დააგენერირეთ ციფრი ქვემოთ მოცემულ გრაფიკზე და იხილეთ პროგნოზი რეალურ დროში
                    <b>Interpret button</b> გვეხმარება გავიგოთ, თუ რის მიხედვიტ ახდენს მოდელი პროგნოზირებას. 
                    ...
                    ამგვარად, შეგვიძლიათ ვნახოთ, თუ რომელ მახასიათებლებზე გაამახვილა ყურადღება მოდელმა ჩვენს მიერ დახატული ციფრის იდენტიფიცირებისას.</p> """, unsafe_allow_html=True)
else:
    ...
    st.markdown("""<p style="color:#3A485F;">Draw a digit on the canvas below and see real-time predictions 
                <b>The Interpret button</b> helps you understand how the model makes predictions. 
